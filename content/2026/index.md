...
Moven Tsai: Developer at Ethereum Foundation (PSE)
{{% /expand %}}
...
{{% expand title="Ghous Amjad (he/him)" %}}
Ghous is a Senior Software Engineer in the Private Computing & Cryptography Research group at Google based in New York City, currently working on implementing Anonymous Tokens and similar privacy solutions at scale. Before joining Google, Ghous obtained a PhD in Computer Science from Brown University under the supervision of Dr. Seny Kamara, focusing on theoretical and applied problems in cryptography, particularly in encrypted search, structured encryption, and private data structures.
{{% /expand %}}
